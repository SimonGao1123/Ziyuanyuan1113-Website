// === ThumbSlide.js === (inline thumbnail selector)
(() => {
    const selectorImg = document.querySelector('.default-selector');
    const prevB = document.querySelector('.section.two .prevThumb');
    const nextB = document.querySelector('.section.two .nextThumb');
